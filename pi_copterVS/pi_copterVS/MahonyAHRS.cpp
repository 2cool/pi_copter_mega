...
void MahonyAHRS::AHRSupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz, float dt) {
	float recipNorm;
...
void MahonyAHRS::AHRSupdateIMU(float gx, float gy, float gz, float ax, float ay, float az, float dt) {
	float recipNorm;
