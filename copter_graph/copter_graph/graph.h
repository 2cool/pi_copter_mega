...
enum {
	...
	GYRO_PITCH,GYRO_ROLL,GYRO_YAW,MI0,MI1,MI2,MI3,BAT_F,ACC,ACCX,ANGLE,GACC,ACCY,ACCZ,GACCX,GACCY,GACCZ,PRESSURE,PRESSURE_SPEED,PRESSURE_ACC,SX,SY,X2HOME,Y2HOME,G_SPEED_X,G_SPEED_Y,G_SPEED,GX,GY,dX,SPEED_X,dY,SPEED_Y,
