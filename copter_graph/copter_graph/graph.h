...
static float fly_at_altitude = 0;
static uint32_t old_control_bits = 0;
...
enum {
	...
	GYRO_PITCH,GYRO_ROLL,GYRO_YAW, MAXACC,MI0,MI1,MI2,MI3,BAT_F,ACC,ACCX,ANGLE,
	GACC,ACCY,ACCZ,GACCX,GACCY,GACCZ,PRESSURE,PRESSURE_SPEED,PRESSURE_ACC,SX,SY,X2HOME,
	Y2HOME,G_SPEED_X,G_SPEED_Y,G_SPEED,GX,GY,dX,SPEED_X,dY,SPEED_Y,
	SZ,GPS_Z,SPEED_Z,THROTTLE,F0,F1,F2,F3,I_THROTHLE,I_YAW,I_YAW_OFFSET,I_PITCH,I_ROLL, 
	Y,X,TIME,DT,M_C_PITCH,M_C_ROLL,EXP0,EXP1,EXP2,EXP3, F_Z, STAB_Z,STAB_SPEED_Z,
